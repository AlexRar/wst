(() => {
    ...
    var A, e = {
        3155: (A, e, t) => {
            var r = t(4467), n = t(467), a = t(4756), s = t.n(a), o = t(3499), i = t(4605), c = t(9620), l = t(1460), u = t(9022), d = t(9589), p = t(4689), g = t(453), w = navigator.userAgent.includes("Safari") && !navigator.userAgent.includes("Chrome");
            function h(A) {
                    ...
                    return (0, n.A)(s().mark((function t() {
                        ...
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                              ...
                              case 3:
                                if (n = t.sent, a = (0, M.A)(n, 1), (o = a[0]).url && o.filename) {
                                    t.next = 8;
                                    break;
                                }
                ...
                getSelector(A) {
                    return (0, n.A)(s().mark((function e() {
                        ...
                        return s().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                              case 0:
                                return t = A.sidebar_for_page_single_track, r = A.sidebar_row_selector, n = A.sidebar_top_button, 
                                e.abrupt("return", [ t, r, n ].join(","));
                    ...
                    return (0, n.A)(s().mark((function e() {
                        ...
                        return s().wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                              ...
                              case 6:
                                if (r = e.sent, n = (0, M.A)(r, 1), (a = n[0]).url && a.filename) {
                                    e.next = 13;
                                    break;
                                }
            ...
            class J extends i.z {
                ...
                initObserver() {
                    ...
                    E() && this.mutationHandlers.push(new b(this.selectorsConfig.soundcloud));
