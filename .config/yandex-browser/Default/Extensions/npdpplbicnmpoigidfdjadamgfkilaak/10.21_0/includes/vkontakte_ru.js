(() => {
    ...
    var e, t = {
        5914: (e, t, n) => {
            ...
            var ee = n(7725), te = n(4689), ne = n(453), re = n(9949);
            function oe(e, t) {
                var n = Object.keys(e);
                if (Object.getOwnPropertySymbols) {
                    var r = Object.getOwnPropertySymbols(e);
            ...
            P.A.isSingle() && (0, u.Ys)("vk", (function(e, t) {
                ...
                var R, E, T, H, V, U, j, z = [], W = {}, $ = {
                    ...
                    mutationMode: {
                        ...
                        onVideoInsert: function(e) {
                            (0, B.A)("function(){return window.mvcur&&window.mvcur.mvData&&window.mvcur.mvData.is_active_live}").then((t => {
                                ...
                                r || (r = e);
                                var o = fe.getPlayerNode(r);
                                o && !t ? e.closest(".ShortVideoPost") || window.location.href.includes("clip") ? fe.newClipButton(o, r) : fe.newAppendButton(o, r) : e.dataset.sfSkip = 0;
                            }));
                        },
                        ...
                        enable: function() {
                            ...
                            this.observer = new C.A({
                                queries: [ {
                                    ...
                                    is: "added",
                                    callback: t => {
                                        for (var n, r = 0; n = t.added[r]; r++) (n = n.parentNode).dataset.sfSkip > 0 || (n.dataset.sfSkip = "1", 
                                        e.onVideoChange(n));
                                    }
                                }, {
                                    css: M.vk.photosAdd,
                    ...
                    prepareVideoLinks: e => (0, a.A)(s().mark((function t() {
                        var a, i, l, d, u, c, p, f, h, m, v, g, b, k, y, w, x, _, S, M, P;
                        return s().wrap((function(t) {
                            for (;;) switch (t.prev = t.next) {
                              ...
                              case 32:
                                return _ = t.sent, t.next = 35, q.h(c, _.body);

                              case 35:
                                S = t.sent, M = S.hls, P = S.mp4, a.push(...P, ...M), a = (0, D.W)(a, "href");

                              case 40:
                                return t.next = 42, q.t((0, D.W)(a, "quality", "itag"), (e => 22 == e.itag));
                    ...
                    newAppendButton: function(e, r) {
                        if (e) {
                            ...
                            var o = r.querySelector("#mv_info"), i = o && o.querySelector(".mv_actions_block .like_cont .like_btns");
                            o = null;
                            var d = e => e ? e.querySelector("#mv_top_controls, #VideoLayerInfo__topControls") : null, u = d(r);
                            if (u || (u = d(r.closest("#mv_container"))), i && pe.elIsHidden(i) && (i = null), 
                            i || u) {
                                for (var c, p = !(i || !u), f = r.querySelectorAll("." + G), h = 0; c = f[h]; h++) c.parentNode.removeChild(c);
                                c = null, f = null;
                                var m = x.A.create("div", {
                                    class: [ G, "sf-under-video" ],
                                    style: {
                                        cursor: "pointer"
                                    },
                                    on: [ [ "click", function() {
                                ...
                                if (i) {
                                    ...
                                    v ? v.parentNode.insertBefore(m, v) : i.appendChild(m);
                                } else if (p) {
                                    x.A.create(m, {
                                        class: [ "mv_top_button" ],
                                        style: {
                                    ...
                                    var g = u.firstChild;
                                    if (g) if (pe.elIsHidden(u.lastChild)) {
                                        for (;g.nextElementSibling && !pe.elIsHidden(g.nextElementSibling); ) g = g.nextElementSibling;
                                        g.parentNode.insertBefore(m, g);
                                    } else u.appendChild(m); else u.appendChild(m);
                                }
                            }
                        }
                    },
