...
(() => { // webpackBootstrap
    ...
    (() => {
        ...
        var Promise_prototype_finally = __webpack_require__(651);; // CONCATENATED MODULE: ./src/general/tools/createElement.ts
        ...
        /** @function */
        let typescriptConverter = preObject => Object.assign({}, preObject,
            // @ts-ignore
            {
        ...
        const createElement = (preObject, classModification = className => className) => {
            let object = typescriptConverter(preObject);
        ...
        const tools_createElement = (createElement);; // CONCATENATED MODULE: ./src/bg/contentScripts/notification/notification.css
        /* harmony default export */
        ...
        const css = originalCss.split('}').slice(0, -1).map(part => {
            let [selectors, rules] /*: string[]*/ = part.split('{').map(item => item.trim());
            rules = '{' + rules + '}';
        ...
        (async () => {
            ...
            let {
                ...
                if (data !== null && data !== void 0 && data.show) resolve(data);
            });
            ...
            let elements = (() => {
                ...
                elements.parent = tools_createElement(structure, classModification) /*: any*/ /*: HTMLElement*/ ;
